  ...
  return (
    <header className="h-14 border-b border-gray-200 flex items-center px-4 bg-white">
      ...
      <div className="flex items-center gap-2 mr-8">
        ...
        <span className="font-semibold text-xl">Clover</span>
      </div>
      ...
      <nav className="flex items-center gap-6 flex-1">
        ...
        <a href="/clover-premium" className="text-sm text-gray-700 hover:text-gray-900">
          Clover Premium
        </a> */}
        <a href="/clover-ai" className="text-sm text-gray-700 hover:text-gray-900 flex items-center gap-1">
          Clover AI
      ...
      <div className="flex items-center gap-4">
        ...
        <button className="text-gray-600 hover:bg-gray-100 cursor-pointer border border-gray-300 rounded px-2 py-1 flex items-center gap-1">
          ...
          <a href="/editor" target="_blank" className="text-sm">Clover Editor</a>
        </button>
